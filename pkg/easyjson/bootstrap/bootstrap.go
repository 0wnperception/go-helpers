...
//
//nolint:gocritic,gofumpt,revive,wsl,funlen,gosec,mnd,goconst
package bootstrap
...
const genPackage = "github.com/0wnperception/go-helpers/pkg/easyjson/gen"
...
func (g *Generator) writeMain() (string, error) {
