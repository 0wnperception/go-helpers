// //nolint: forbidigo,wsl,gocognit,misspell,revive,gofumpt,gocritic,gosimple,exhaustive,mnd,godot
package gen
...
const pkgWriter = "github.com/0wnperception/go-helpers/pkg/easyjson/jwriter"
const pkgLexer = "github.com/0wnperception/go-helpers/pkg/easyjson/jlexer"
const pkgEasyJSON = "github.com/0wnperception/go-helpers/pkg/easyjson"
...
func NewGenerator(filename string) *Generator {
	...
	ret.hashString = strconv.FormatUint(uint64(hash.Sum32()), 16)
...
// addType requests to generate encoding/decoding funcs for the given type.
