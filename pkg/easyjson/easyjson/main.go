//nolint:gochecknoglobals,lll,gofumpt,revive,mnd,wsl,err113,goconst
package main
...
import (
	...
	"github.com/0wnperception/go-helpers/pkg/easyjson/bootstrap"
	...
	_ "github.com/0wnperception/go-helpers/pkg/easyjson/gen"
	"github.com/0wnperception/go-helpers/pkg/easyjson/parser"
)
...
func generate(fname string) error {
	...
	if err = p.Parse(fname, fInfo.IsDir()); err != nil {
		return fmt.Errorf("error parsing %v: %w", fname, err)
	}
