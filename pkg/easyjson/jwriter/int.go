//nolint:revive,mnd,gochecknoglobals,wsl,gochecknoinits,godot
package jwriter
...
func init() {
	var b [2]byte
	*(*uint16)(unsafe.Pointer(&b)) = uint16(0xABCD) //nolint:gosec
...
func appendInt(b []byte, n int64) []byte {
	if n < 0 {
		return formatInteger(b, uint64(-n), true)
	}

	return formatInteger(b, uint64(n), false)
}
...
func formatInteger(out []byte, n uint64, negative bool) []byte {
	...
	u := (*[11]uint16)(unsafe.Pointer(&b)) //nolint:gosec
