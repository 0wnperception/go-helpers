...
func TestOptUInt8_IsDefined(t *testing.T) {
	v := OptUInt8{}
...
func TestOptUInt8_MarshalJSON(t *testing.T) {
	s := NewUint8(87)
...
func TestOptUInt8_Scan(t *testing.T) {
	v := NewUint8(4)
...
func TestOptUInt8_String(t *testing.T) {
	v := OptUInt8{}
...
func TestOptUInt8_UnmarshalJSON(t *testing.T) {
	s := OptUInt8{}
...
func TestOptUInt8_Value(t *testing.T) {
	v := OptUInt8{}
...
func TestOptUInt8_LogValue(t *testing.T) {
	v := OptUInt8{}
