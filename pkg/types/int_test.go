...
func TestOptInt_NewInt(t *testing.T) {
	v := NewInt(5)
	if !(v.Defined && v.V == 5) {
...
func TestOptInt_SetValue(t *testing.T) {
	v := OptInt{}
...
func TestOptInt_Undefine(t *testing.T) {
	v := NewInt(10)
...
func TestOptInt_MarshalJSON(t *testing.T) {
	s := NewInt(8765)
...
func TestOptInt_UnmarshalJSON(t *testing.T) {
	s := OptInt{}
...
func TestOptInt_Scan(t *testing.T) {
	v := NewInt(4)
...
func TestOptInt_Value(t *testing.T) {
	v := OptInt{}
...
func TestOptInt_Equal(t *testing.T) {
	v1 := NewInt(2)
	v2 := NewInt(3)
...
func TestOptInt_LogValue(t *testing.T) {
	v := OptInt{}
